...
dat_ols <- simdat(n = n, effect = 1, sigma_Y = 1, model = "ols")
...
dat_logistic <- simdat(n = n, effect = 1, sigma_Y = 1, model = "logistic")
...
The `summary` method gives more detailed information about the estimated coefficients, standard errrors, and confidence limits:
