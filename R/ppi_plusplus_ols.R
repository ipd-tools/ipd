...
#' N <- nrow(X_u)
#'
#' ppi_plusplus_ols_est(X_l, Y_l, f_l, X_u, f_u, n, p, N)
#'
#' @import stats
#'
#' @export

ppi_plusplus_ols_est <- function(X_l, Y_l, f_l, X_u, f_u, n, p, N,
...
ppi_plusplus_ols <- function(X_l, Y_l, f_l, X_u, f_u, n, p, N,
  ...
  if (is.null(lhat)) {
    ...
    return(ppi_plusplus_ols(X_l, Y_l, f_l, X_u, f_u, n, p, N,
